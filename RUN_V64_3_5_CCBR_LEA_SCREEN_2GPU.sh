...
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_5_ccbr_lea_activation_screen_2gpu_v1}"
export GPUS="${GPUS:-0,1}"
export NPROC_PER_NODE=2
export TRAIN_CONFIG="${TRAIN_CONFIG:-bdse/configs/v64_3_5_cc_aocc_ccbr_lea_daepc_screen_2gpu.yaml}"
...
files=['bdse/model/bdse_model.py','bdse/model/losses.py','bdse/experiments/evaluate_open_loop.py','bdse/experiments/train.py','RUN_V64_3_5_CCBR_LEA_SCREEN_2GPU.sh']
...
python -m bdse.tools.check_v64_3_3_acquisition_screen \
  ...
  --variant CCBR+LEA+ACRA-full-support
