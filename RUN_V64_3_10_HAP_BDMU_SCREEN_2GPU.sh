...
if not r.get('full_promotion', False):
    raise SystemExit('V64.3.7 DARM+DBR full causal/value gate is not promoted; HAP-BDMU is blocked.')
...
# V64.3.10 requires fixed-reference BDMU validation loss metrics in addition to
...
export TRAIN_CONFIG="bdse/configs/v64_3_10_cc_aocc_hap_bdmu_daepc_screen_2gpu.yaml"
export EVAL_CONFIG="bdse/configs/v64_3_10_cc_aocc_hap_bdmu_cl.yaml"
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_10_hap_bdmu_screen_2gpu_v1}"
...
python -m bdse.tools.check_v64_3_10_hap_bdmu_screen \
  ...
  --output "$OUT_ROOT/provenance/v64_3_10_hap_bdmu_screen.json"
echo "[v64.3.10] screen report: $OUT_ROOT/provenance/v64_3_10_hap_bdmu_screen.json"
