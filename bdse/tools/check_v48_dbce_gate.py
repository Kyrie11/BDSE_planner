...
def main() -> int:
    parser = argparse.ArgumentParser(description="Strict v48 DBCE/AOCC open-loop gate with token-paired regret")
    ...
    print(f"\nV48 DBCE/AOCC open-loop gate [{'PASS' if not failures else 'FAIL'}]")
