...
export TRAIN_CONFIG="bdse/configs/v64_3_7_cc_aocc_darm_dbr_broad_daepc_screen_2gpu.yaml"
export EVAL_CONFIG="bdse/configs/v64_3_7_cc_aocc_darm_dbr_broad_cl.yaml"
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_7_darm_dbr_broad_screen_2gpu_v1}"
...
python -m bdse.tools.check_v64_3_7_darm_dbr_screen --train-log "$OUT_ROOT/train/bdse_v64_saqa_bcc.train_log.jsonl" --variant 'DARM+DBR-BROAD' --output "$OUT_ROOT/provenance/v64_3_7_darm_dbr_screen.json"
