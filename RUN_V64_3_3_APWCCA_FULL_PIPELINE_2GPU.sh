...
cd "$SCRIPT_DIR"
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_3_apwcca_daepc_fast_2gpu_v1}"
export TRAIN_CONFIG="${TRAIN_CONFIG:-bdse/configs/v64_3_3_cc_aocc_apwcca_daepc_train_2gpu.yaml}"
