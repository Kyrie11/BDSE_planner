...
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_4_fpcca_nolba_activation_screen_2gpu_v1}"
export GPUS="${GPUS:-0,1}"
export NPROC_PER_NODE=2
export TRAIN_CONFIG="${TRAIN_CONFIG:-bdse/configs/v64_3_4_cc_aocc_fpcca_daepc_screen_2gpu.yaml}"
...
files=[
  ...
  'RUN_V64_3_4_FPCCA_NOLBA_ACTIVATION_SCREEN_2GPU.sh',
]
out={}
for name in files:
...
python -m bdse.tools.check_v64_3_3_acquisition_screen \
  ...
  --variant FPCCA-noLBA+ACRA-full-support
