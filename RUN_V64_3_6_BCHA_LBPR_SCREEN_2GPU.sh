...
export TRAIN_CONFIG="bdse/configs/v64_3_6_cc_aocc_ccbr_bcha_lbpr_lea_daepc_screen_2gpu.yaml"
export EVAL_CONFIG="bdse/configs/v64_3_6_cc_aocc_ccbr_bcha_lbpr_lea_cl.yaml"
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_6_bcha_lbpr_screen_2gpu_v1}"
...
python -m bdse.tools.check_v64_3_6_dual_bottleneck_screen --train-log "$OUT_ROOT/train/bdse_v64_saqa_bcc.train_log.jsonl" --variant 'CCBR+BCHA+LBPR+LEA' --output "$OUT_ROOT/provenance/v64_3_6_dual_screen.json"
