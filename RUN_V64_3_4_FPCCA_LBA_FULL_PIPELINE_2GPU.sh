...
cd "$SCRIPT_DIR"
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_4_fpcca_lba_daepc_fast_2gpu_v1}"
export TRAIN_CONFIG="${TRAIN_CONFIG:-bdse/configs/v64_3_4_cc_aocc_fpcca_lba_daepc_train_2gpu.yaml}"
export EVAL_CONFIG="${EVAL_CONFIG:-bdse/configs/v64_3_4_cc_aocc_fpcca_cl.yaml}"
export FOUNDATION_CONTROL_CONFIG="${FOUNDATION_CONTROL_CONFIG:-bdse/configs/v64_3_4_cc_aocc_fpcca_anchor_control_cl.yaml}"
export LOCAL_CONTROL_CONFIG="${LOCAL_CONTROL_CONFIG:-bdse/configs/v64_3_4_cc_aocc_fpcca_local_control_cl.yaml}"
