...
cd "$SCRIPT_DIR"
export OUT_ROOT="${OUT_ROOT:-outputs_v64_3_4_fpcca_nolba_daepc_fast_2gpu_v1}"
export TRAIN_CONFIG="${TRAIN_CONFIG:-bdse/configs/v64_3_4_cc_aocc_fpcca_daepc_train_2gpu.yaml}"
